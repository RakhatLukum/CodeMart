...
type CartServiceClient interface {
	...
	RemoveFromCart(ctx context.Context, in *CartRequest, opts ...grpc.CallOption) (*CartResponse, error)
	GetCart(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*CartItems, error)
}
...
func (c *cartServiceClient) AddToCart(ctx context.Context, in *CartRequest, opts ...grpc.CallOption) (*CartResponse, error) {
...
func (c *cartServiceClient) RemoveFromCart(ctx context.Context, in *CartRequest, opts ...grpc.CallOption) (*CartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CartResponse)
...
func (c *cartServiceClient) GetCart(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*CartItems, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CartItems)
...
type CartServiceServer interface {
	...
	RemoveFromCart(context.Context, *CartRequest) (*CartResponse, error)
	GetCart(context.Context, *UserIdRequest) (*CartItems, error)
...
func (UnimplementedCartServiceServer) AddToCart(context.Context, *CartRequest) (*CartResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToCart not implemented")
}
func (UnimplementedCartServiceServer) RemoveFromCart(context.Context, *CartRequest) (*CartResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveFromCart not implemented")
}
func (UnimplementedCartServiceServer) GetCart(context.Context, *UserIdRequest) (*CartItems, error) {
