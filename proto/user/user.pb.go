...
const file_user_proto_rawDesc = "" +
	...
	"\x05email\x18\x02 \x01(\tR\x05email2\xa9\x01\n" +
	"\vUserService\x125\n" +
	"\bRegister\x12\x15.user.RegisterRequest\x1a\x12.user.UserResponse\x12/\n" +
	"\x05Login\x12\x12.user.LoginRequest\x1a\x12.user.UserResponse\x122\n" +
	"\aGetUser\x12\x13.user.UserIdRequest\x1a\x12.user.UserResponseB\x1cZ\x1aCodeMart/proto/user;userpbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 2: user.UserService.GetUser:input_type -> user.UserIdRequest
