...
const file_product_proto_rawDesc = "" +
	...
	"\n" +
	"TagRequest\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag2\xc6\x01\n" +
	...
	"\x10GetProductsByTag\x12\x13.product.TagRequest\x1a\x14.product.ProductListB\"Z CodeMart/proto/product;productpbb\x06proto3"
...
var file_product_proto_depIdxs = []int32{
	...
	2, // 4: product.ProductService.GetAllProducts:output_type -> product.ProductList
	1, // 5: product.ProductService.GetProductById:output_type -> product.Product
	2, // 6: product.ProductService.GetProductsByTag:output_type -> product.ProductList
